    ...
    <div class="home">
        <header>
            <div class="content" id="header">
                <div class="logo">
                    <a href="/mystery"><img v-show="!logoHFlag" :src="logoHSrcP" @mouseenter="logoHFlag = true" alt=""></a>
                    <a href="/mystery"><img v-show="logoHFlag" :src="logoHSrcG" @mouseleave="logoHFlag = false" alt=""></a>
                </div>
            ...
            <div class="nfts-wrap">
                <div class="top">
                    ...
                    <div class="rights">
                        ...
                        <div class="search">
                            <img src="@/assets/nwboxPhone/search.svg" alt="">
                ...
                <ul class="sale">
                    <li class="sale-active">
                        ...
                        <div class="intro">
                            ...
                            <div class="desc">
                                <img src="@/assets/nwboxPhone/nfts-icon.svg" alt="">
                                <div class="price">
                                    204,30 <br/>
                                    <span>≈$20</span>
                                </div>
            ...
            .nfts-wrap{
                ...
                .sale{
                    ...
                    li{
                        ...
                        margin-bottom: 11px;
                        padding: 8px 33px;
                        background-image: url('../../../assets/nwboxPhone/nfts-cardbg.svg');
                        background-size: 100% 100%;
                        overflow: hidden;
                        .showarea{
                            position: relative;
                            ...
                            .legen{
                                ...
                                .bg{
                                    width: 113px;
                                    height: 21px;
                                    background: linear-gradient(224deg, #A240FF 0%, #35FFAD 33%, #D9E1FF 75%, #691EFF 100%);
                                    filter: blur(2px);
                                    clip-path: polygon(0 0, 100% 0, 100% 52%, 92% 100%, 0 100%);
                                }
                                div:nth-child(2){
                                    position: absolute;
                                    top: 0;
                            ...
                            .countdown{
                                ...
                                border-radius: 4px;
                                backdrop-filter: blur(2.2308000000000003px);
                                text-align: right;
                                .name{
                                    height: 20px;
                                    font-size: 15px;
                    ...
                    li.sale-active{
                        filter: drop-shadow(0 0 7px #8BDDFF);
                    }
                }
            }
            .line{
