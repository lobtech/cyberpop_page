    ...
    <div class="home">
        <header>
            <div class="content" id="header">
                <div class="logo">
                    <a href="/privacy"><img v-show="!logoHFlag" :src="logoHSrcP" @mouseenter="logoHFlag = true" alt=""></a>
                    <a href="/privacy"><img v-show="logoHFlag" :src="logoHSrcG" @mouseleave="logoHFlag = false" alt=""></a>
                </div>
                <div class="user">
                    <!-- <div class="language">
